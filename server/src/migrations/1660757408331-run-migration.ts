...
export class runMigration1660757408331 implements MigrationInterface {
    name = 'runMigration1660757408331'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "label" (
                ...
                CONSTRAINT "REL_d719c8edaf77ac62f47529a4d1" UNIQUE ("mslId"),
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ALTER TABLE "label" DROP CONSTRAINT "FK_d719c8edaf77ac62f47529a4d1d"
        `);
        await queryRunner.query(`
